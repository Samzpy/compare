...
class PHONE_Spider:
    def __init__(self):
        self.url='https://www.philips.com.tw/c-m-so/tv/latest#page={}&layout=12'
        ...
        for i in range(self.get_count()):
            ...
            if html:
                ...
                for i in li_list:
                    ...
                    pn=i.xpath('.//p[@class="p-pc05v2__card-ctn p-body-copy-03 p-heading-light"]/text()')[0].strip()
                    name='PHILIPS飛利浦 '+name+' '+pn
                    img=i.xpath('.//picture[@class="p-picture p-product-picture"]/img/@src')[0]
                    keyword='PHILIPS '+pn
                    name_list.append(['philps','電視',name,pn,keyword,img])
