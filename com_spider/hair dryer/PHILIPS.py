...
class PHONE_Spider:
    def __init__(self):
        self.url='https://www.philips.com.tw/c-m-pe/haircare/hair-dryers/latest#filters=HAIR_DRYERS_SU&page={}'
        ...
        for i in range(self.get_count()):
            ...
            if html:
                ...
                for i in li_list:
                    ...
                    name="PHILIPS飛利浦 " +pn+' '+name
                    keword='PHILIPS '+pn
                    name_list.append(['philips','hairdryer',name,pn,keword,img])
